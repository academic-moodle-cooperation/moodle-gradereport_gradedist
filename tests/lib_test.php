...
class lib_test extends \advanced_testcase {
    ...
    public function test_get_gradeitems() {
        ...
        $this->report = new grade_report_gradedist($this->course->id, new grade_plugin_return(), context_course::instance($this->course->id), [1, 2, 3, 4, 5], 0, 0);
        $result = $this->report->get_gradeitems();
    ...
    public function test_load_distribution() {
        ...
        // Used for debugging: print_r($result);
